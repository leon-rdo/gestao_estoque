# Generated by Django 5.0.1 on 2024-05-15 02:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='origin',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='origin', to='inventory_management.transferareas', verbose_name='Origem'),
        ),
        migrations.AlterField(
            model_name='stocktransfer',
            name='transfer_area',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory_management.transferareas', verbose_name='Área de Transferência'),
        ),
        migrations.AlterField(
            model_name='write_off',
            name='transfer_area',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory_management.transferareas', verbose_name='Área de transferência'),
        ),
        migrations.CreateModel(
