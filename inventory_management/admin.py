...
def download_qr_codes(modeladmin, request, queryset):
    ...
    #     return response
    # else:
    #     # Renderize o modal HTML
    #     return render(request, 'admin\inventory_management\productunit\productunit_custom_qr_codes.html')

download_qr_codes.short_description = "Baixar QR Codes"

def generate_qr_codes_with_params(queryset, param1, param2, request, file_path):
    c = canvas.Canvas(file_path, pagesize=letter)
